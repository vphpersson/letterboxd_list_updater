module github.com/vphpersson/letterboxd_list_updater
...
require (
	...
	github.com/vphpersson/letterboxd_list_updater/api v0.0.8
)
...
require (
	...
	github.com/vphpersson/type_generation v0.0.25 // indirect
